...
abstract contract AcolyteBrandingDeploymentChecks is Script {
    ...
    function _verifyCanonicalDependencies() internal view {
        ...
        ICanonicalIdentityRegistryVersion registryVersion =
            ICanonicalIdentityRegistryVersion(CANONICAL_IDENTITY_REGISTRY);
        try registryVersion.getVersion() returns (string memory version) {
